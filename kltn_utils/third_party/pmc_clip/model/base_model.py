...
from ..tokenizer import simple_tokenizer, tokenize
from ..utils import to_2tuple
from .blocks import LayerNorm, ModifiedResNet, QuickGELU, Transformer
...
class CLIP(nn.Module):
    ...
    def forward(self, batch):
        ...
        clip_prediction = dict.fromkeys(
            ["image_features", "text_features", "logit_scale", "bert_prediction"], None
        )
